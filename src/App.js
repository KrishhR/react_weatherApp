...
function App() {
  ...
  useEffect(()=>{
    ...
    let changeTheme = location.current.condition.text.toLowerCase();
    if (changeTheme.indexOf("sun") > -1) {
      theme =
      ...
      changeTheme.indexOf("cloud") > -1 ||
      changeTheme.indexOf("mist") > -1 ||
      changeTheme.indexOf("overcast") > -1
    ) {
      theme =
      ...
      changeTheme.indexOf("rain") > -1 ||
      changeTheme.indexOf("drizz") > -1
    ) {
      theme =
      ...
      changeTheme.indexOf("freez") > -1 ||
      changeTheme.indexOf("snow") > -1 ||
      changeTheme.indexOf("sleet") > -1 ||
      changeTheme.indexOf("blizzard") > -1
    ) {
      theme =
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzqi3IScIzuHifT85lrRc3uUKDdAWfa5Lesg&usqp=CAU";
      document.body.style.background = `url(${theme})`;
